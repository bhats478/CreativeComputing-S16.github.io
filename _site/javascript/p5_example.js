...
$(function() {
	$(".p5_example.show-lab").each(function(i, e) {
		var preview = $('<div class="code-preview"></div>');
	...
	$(".p5_example.show-lab-link").each(function(i, e) {
		...
		var link = $("<a class='lab-link btn btn-xs btn-default'>Open in Editor</a>").attr("href", base_url + "p5_lab.html?" + e.href);
		bar.append(link);
	...
	$(".p5_example.show-titled-lab-link").each(function(i, e) {
		var bar = $("<div class='button-bar'>");
		var link = $("<a class='lab-link btn btn-xs btn-default'>Open "+$(e).text()+" in Editor</a>").attr("href", base_url + "p5_lab.html?" + e.href);
		bar.append(link);
